...
/// Configuration for an [`OpenAiBridge`](crate::OpenAiBridge) instance.
#[derive(Debug, Clone)]
...
impl Default for OpenAiBridgeConfig {
    fn default() -> Self {
        Self {
            node_command: None,
            host_script: None,
...
impl OpenAiBridgeConfig {
    /// Create a default configuration.
    pub fn new() -> Self {
        Self::default()
    }

    /// Set the OpenAI API key (`OPENAI_API_KEY` env var).
    pub fn with_api_key(mut self, key: impl Into<String>) -> Self {
        self.env.insert("OPENAI_API_KEY".into(), key.into());
        self
    }
