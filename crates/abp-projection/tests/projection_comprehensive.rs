...
//! construction, backend registration, capability-based selection, priority
//! ordering, fallback chains, model mapping, cost optimization, latency
//! optimization, query, persistence/serde, empty matrix, error handling,
//! tiebreaking, dynamic updates, cross-dialect routing, mapper selection,
//! multiple work orders, and fidelity scoring.
