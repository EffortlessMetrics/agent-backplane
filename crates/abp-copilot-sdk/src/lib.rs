...
pub const BACKEND_NAME: &str = "sidecar:copilot";

/// Relative path to the JS Copilot host inside a workspace checkout.
pub const HOST_SCRIPT_RELATIVE: &str = "hosts/copilot/host.js";

/// Preferred executable for the default Copilot sidecar host.
pub const DEFAULT_NODE_COMMAND: &str = "node";

/// Register the Copilot sidecar backend if available.
...
/// Register a Copilot backend under a custom name.
