...
`agent-backplane` has three verification surfaces:
...
Pull requests run advisory `ripr` evidence, fast gates, docs, and targeted mutation when routing rules require it.
