...
use abp_core::{
    ...
    BackendIdentity, Capability, CapabilityManifest, ContractError, ExecutionMode, Outcome,
    Receipt, ReceiptBuilder, RunMetadata, SupportLevel, UsageNormalized, VerificationReport,
    CONTRACT_VERSION,
};
